...
ELF_BOOTLOADER=build/p2t8_boot_${PFM2_BOOTLOADER_VERSION_NUMBER}.elf
BIN_BOOTLOADER=build/p2t8_boot_${PFM2_BOOTLOADER_VERSION_NUMBER}.bin
SYMBOLS_BOOTLOADER=build/symbols_p2t8_boot_${PFM2_BOOTLOADER_VERSION_NUMBER}.txt

ELF_FIRMWARE=build/p2t8_${PFM2_VERSION_NUMBER}.elf
ELF_FIRMWARE_O=build/p2t8_${PFM2_VERSION_NUMBER}o.elf
BIN_FIRMWARE=build/p2t8_${PFM2_BIN_NUMBER}.bin
BIN_FIRMWARE_O=build/p2t8_${PFM2_BIN_NUMBER}o.bin
SYMBOLS_FIRMWARE=build/symbols_p2t8_${PFM2_VERSION_NUMBER}.txt
SYMBOLS_FIRMWARE_O=build/symbols_p2t8_${PFM2_VERSION_NUMBER}o.txt

BIN_SYSEX=build/p2t8_${PFM2_VERSION_NUMBER}.syx
